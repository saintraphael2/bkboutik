...
<div class="form-group col-sm-2">
    ...
    <select class="select2 form-control" name="typecontrat" id="typecontrat", required=required>
        <?php $__currentLoopData = $typecontrats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typecontrat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($typecontrat->id); ?>"><?php echo e($typecontrat->libelle); ?></option>
...
<!-- <div class="form-group col-sm-4">
    ...
    <?php echo Form::text('numero', null, ['class' => 'form-control', 'required', 'maxlength' => 100, 'maxlength' => 100]); ?>
...
<div class="form-group col-sm-2">
    ...
    <select class="select2 form-control" name="moto" id="moto", required=required>
        <?php $__currentLoopData = $motos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $moto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($moto->id); ?>"><?php echo e($moto->immatriculation); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
...
<!-- <div class="form-group col-sm-3">
    ...
    <?php echo Form::number('conducteur', null, ['class' => 'form-control', 'required']); ?>
...
<div class="form-group col-sm-2" style="margin-top: 2rem;">
    <!-- <div class="form-check">
        <?php echo Form::hidden('bdeposit', 0, ['class' => 'bdeposit form-check-input']); ?>

        <?php echo Form::checkbox('bdeposit', '1', null, ['class' => 'bdeposit form-check-input']); ?>

        <?php echo Form::label('bdeposit', 'Confirmer les frais de dossier ', ['class' => 'form-check-label']); ?>
...
<div class="form-group col-sm-2">
    ...
    <!-- <?php echo Form::number('deposit', null, ['class' => 'form-control', 'required', 'disabled']); ?> -->
...
<!-- Montant Field -->
<!-- <div class="form-group col-sm-3">
    <?php echo Form::label('montant', 'Montant :'); ?>

    <?php echo Form::number('montant', null, ['class' => 'form-control', 'required']); ?>
...
<div class="form-group col-sm-3">
    <?php echo Form::label('date_signature', 'Date Signature (jj-mm-aaaa) :'); ?>

    <?php echo Form::text('date_signature', null, ['class' => 'form-control','id'=>'date_signature']); ?>
...
<!-- Date Debut Field -->
<div class="form-group col-sm-3">
    <?php echo Form::label('date_debut', 'Date Debut (jj-mm-aaaa) :'); ?>
...
<!-- Datprm Field -->
<div class="form-group col-sm-3">
    <?php echo Form::label('datprm', 'Date Premier Paiement (jj-mm-aaaa) : '); ?>

    <?php echo Form::text('datprm', null, ['class' => 'form-control','id'=>'datprm']); ?>
...
<div class="form-group col-sm-12 col-lg-12">
    ...
    <?php echo Form::textarea('observation', null, ['class' => 'form-control', 'required', 'maxlength' => 16777215, 'rows' => 3]); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\inetpub\wwwroot\bkzed\resources\views/contrats/forms/create/contrat/fields.blade.php ENDPATH**/ ?>