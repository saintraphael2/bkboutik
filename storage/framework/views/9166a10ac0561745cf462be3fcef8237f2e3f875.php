          ...
          <div class="form-step">
            ...
            <div class="card-body">
              <form id="storeConducteur" action="#" method="POST">
                ...
                <div class="row">
                    <?php echo $__env->make('contrats.forms.create.conducteur.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
              </form>
            </div>
            <div class="d-block text-right card-footer">
              <div class="col-xl-12 col-12">
                <a href="<?php echo e(route('contrats.index')); ?>" class="btn btn-default pull-right cancel-step">
          ...
          <div class="form-step">
            ...
            <div class="card-body">
              <form id="storeCaution" action="#" method="POST">
                ...
                <div class="row">
                    <?php echo $__env->make('contrats.forms.create.caution.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <br>
                ...
                <div class="row secondCautionSection hidden">
                    <?php echo $__env->make('contrats.forms.create.caution.fields_second', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
              </form>
            </div>
            <div class="d-block text-right card-footer">
          ...
          <div class="form-step hide">
            ...
            <div class="card-body">
              <form id="storeContrat" action="#" method="POST">
                ...
                <div class="row">
                    <?php echo $__env->make('contrats.forms.create.contrat.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
              </form>
            </div>
            <div class="d-block text-right card-footer">
...
<script>
  ...
  setConducteur(<?php echo json_encode($conducteur, 15, 512) ?>)
  setRedirectUrl('<?php echo e(route('contrats.index')); ?>')
  configStepsLimit(3)
  initializeTheView()
  ...
  function validateStep(step) {
    ...
    if(progression[step-1]){
      ...
      if(step == 1){
        ...
        $.ajax({
            type : "POST",
            url  : '<?php echo e(route('conducteurs.store')); ?>',
        ...
        $.ajax({
            type : "POST",
            url  : '<?php echo e(route('cautions.store')); ?>',
        ...
        $.ajax({
            type : "POST",
            url  : '<?php echo e(route('contrats.store')); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\wwwroot\bkzed\resources\views/contrats/create.blade.php ENDPATH**/ ?>