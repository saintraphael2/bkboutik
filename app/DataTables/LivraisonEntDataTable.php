...
class LivraisonEntDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable
       ->editColumn('vente', function ($request) {
            return $request->ventes->code;
        })
         
        ->editColumn('date_facture', function ($request) {
            return $request->ventes->created_at->format('d-m-Y');
        })
        ...
        ->addColumn('action', 'livraisonsEnt.datatables_actions');
    }
    ...
    {
        return $model->newQuery()->whereNotNull('vente');
    }
...
//                    ['extend' => 'reload', 'className' => 'btn btn-default btn-sm no-corner',],
    ...
    protected function getColumns()
    {
        return [
            ...
            'vente'=>['title'=>'FACTURE ENTREPRISE'],
