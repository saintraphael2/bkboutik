...
use App\DataTables\LivraisonEntDataTable;
...
class LivraisonEntController extends AppBaseController
{
     ...
     */
    public function index(LivraisonEntDataTable $livraisonEntDataTable)
    {
    return $livraisonEntDataTable->render('livraisonsEnt.index');
    }
