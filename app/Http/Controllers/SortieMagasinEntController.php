...
use App\DataTables\SortieMagasinEntDataTable;
...
class SortieMagasinEntController extends AppBaseController
{
    ...
    public function __construct(DetailVenteRepository $detailVenteRepo,ClientRepository $clientRepo, StockRepository $stockRepo, VenteRepository $venteRepo, ParametreRepository $parametreRepo)
    {
     ...
     */
    public function index(SortieMagasinEntDataTable $sortieMagasinEntDataTable)
    {
    return $sortieMagasinEntDataTable->render('sortie_magasinEnt.index');
    }
   ...
   Storage::disk('uploads')->put('caisse/'.$filename, $pdfRecu->output());
    ...
    public function show($id)
    {
        ...
        $detailsVente=DetailVente::where('vente',$id)->get();
        ...
        return view('sortie_magasinEnt.show')->with(['vente'=> $vente,'detailsVente'=>$detailsVente]);
    }
